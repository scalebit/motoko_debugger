use super::{Executor_debugger, InstructionPtr};
use crate::{
    core::TrapCode,
    engine::{
        code_map::CompiledFuncRef,
        executor_debugger::stack::{CallFrame, FrameParams, ValueStack},
...
impl Executor_debugger<'_> {
    ...
    ///
    /// [`CallStack`]: crate::engine::executor_debugger::stack::CallStack
