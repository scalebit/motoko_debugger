(module $lib_wasm.wasm
  ...
  (func $_ZN8lib_wasm7inc_mut17hf20392d4179701e0E (type $t3) (param $p0 i32)
    ...
    (call $_ZN4core9panicking11panic_const24panic_const_add_overflow17h76ec5bef6e5a6f3eE
      (local.get $l12))
    (unreachable))
  (func $_ZN8lib_wasm3inc17h1519e8323806cda0E (type $t4) (param $p0 i32) (result i32)
    (local $l1 i32) (local $l2 i32) (local $l3 i32) (local $l4 i32) (local $l5 i32) (local $l6 i32) (local $l7 i32) (local $l8 i32) (local $l9 i32) (local $l10 i32) (local $l11 i32) (local $l12 i32)
    (local.set $l1
      (global.get $__stack_pointer))
    (local.set $l2
  ...
  (func $testtt (export "testtt") (type $t5)
    ...
    (local.set $l4
      (i32.const 1))
    (local.set $l5
      (call $_ZN8lib_wasm3inc17h1519e8323806cda0E
        (local.get $l4)))
    (i32.store offset=8
      (local.get $l2)
      (local.get $l5))
    ...
    (local.set $l8
      (local.get $l7))
    (call $_ZN8lib_wasm7inc_mut17hf20392d4179701e0E
      (local.get $l8))
    (local.set $l9
      (i32.const 16))
    (local.set $l10
